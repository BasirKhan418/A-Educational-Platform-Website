...
const AchieveSuccess = () => {
  return (
    <div className="w-10/12">
      <h2 className="poppins-bold mb-6 text-center text-3xl font-bold text-black lg:text-4xl">
...
>>>>>>> 2b64eddf71738c2ba331a3580862819d24984ae5
          ...
          <div className="absolute -right-8 bottom-0 h-14 w-40 overflow-hidden">
            <img
...
<<<<<<< HEAD
          <div className="relative h-64 w-64  overflow-hidden md:h-96 md:w-96">
            ...
            <div className="absolute right-20 top-10 ">
              <img
                src="https://s3-alpha-sig.figma.com/img/78c2/856f/31c5551f89640e705b216c837cbfe495?Expires=1721606400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=gMVraKMVS9~irc8Gwt7kvpu~y617bpEbVcOLGEvfFoMx57y8JjciIOHJL78YukBchbiMtq5ey71zkUAvO0szrAj1521WP44mKJsXjM6bziyk9zMWOge6qwuEtER8mnO7OI9ONXpeyrrdhfngGrHNQu9r9DVFVy40v97E9nfMB5rp6rYTJ9BZau8UGtznVeY~q2zhR~uQDqszX~D97YivShql6GxT94~weK0XFzVCAShbz2wfsn2ANbVwNp6G4eAuqFX64zWwmINmpYvqFE1diaMP~4Ltt9z5o6q9qPYhuQvE~g6X8dWHS5seQ1Vcdl4Aboo3HoaDhQ1n6y7l1LRbDQ__"
                alt="Students"
                className=" inset-0 h-40 w-20 -rotate-12 object-cover md:h-72 md:w-48 "
                style={{ borderRadius: "83px 83px 83px 6.15px" }}
=======
