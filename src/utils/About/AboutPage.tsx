  ...
  return (
    <div className='min-h-screen flex justify-center items-center flex-col'>
      ...
      <div className="w-full md:w-2/3 mb-8 md:mb-0 lg:w-6/12">
        <h2 className="text-4xl font-bold text-bgcust inter-bold">About us</h2>
        <div className='h-1 w-24 bg-bgcust rounded mb-6 '></div>
        <div className="mb-6">
          <h3 className="text-2xl font-bold mb-3 poppins-bold">VISION</h3>
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-bold mb-6 poppins-bold">MISSION</h3>
      ...
      <div className="w-full md:w-1/3 flex flex-col items-center mt-20">
        ...
        <div className="text-center">
          <h4 className="text-xl font-semibold poppins-bold">Dinesh Gour</h4>
